                ...
                <div className="flex flex-col bigLg:flex-row items-center justify-between gap-12 h-full">
                    ...
                    <div className="flex-1 space-y-6 text-center bigLg:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center bigLg:justify-start">                           
                            <Link href="https://github.com/tahapek5454" target='_blank' aria-label="GitHub projelerimi inceleyin" className="px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-full font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                                Projelerimi İncele
                            </Link>                            
                            <Link 
                            ...
                            <Link href="https://drive.google.com/file/d/1U53fwn20Z8e2nmEErx6jyiX_TJ8FScJK/view?usp=sharing" target='_blank' aria-label="CV dosyamı görüntüleyin" className="px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-full font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                                CV
                            </Link>
                        </div>                        
                        <div className="flex space-x-6 justify-center bigLg:justify-start">                 
                            <Link 
                                ...
                                target="_blank"
                                aria-label="LinkedIn profilimi ziyaret edin"
                            ...
                            <Link 
                                ...
                                target="_blank"
                                aria-label="GitHub profilimi ziyaret edin"
