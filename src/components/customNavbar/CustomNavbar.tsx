    ...
    return (
        <>
            <div className='flex flex-col'>
                        ...
                        <nav className={`hidden md:flex md:justify-between flex-1`}>
                            ...
                            <div className='flex justify-center space-x-7'>
                                <div className='flex justify-start space-x-6'>
                                    <a href="https://github.com/tahapek5454" target='_blank' rel="noreferrer" > <i className="fa-brands fa-github text-gega-grey text-3xl"></i></a>
                                    <a href='https://www.instagram.com/tahapek' target='_blank' rel="noreferrer" > <i className="fa-brands fa-instagram  text-gega-grey text-3xl"></i></a>
                                    <a href='https://www.linkedin.com/in/taha-pek-413b1b221' target='_blank' rel="noreferrer" > <i className="fa-brands fa-linkedin  text-gega-grey text-3xl"></i></a>
                                </div>
                ...
                <div className={`${isExpand? 'pl-7 bg-black py-4 text-gega-grey font-gemunu flex flex-col justify-between' : 'hidden'} md:hidden`}>

                    <div className='bg-gega-grey w-11/12 h-1 rounded-full mb-3'></div>
                    ...
                    <div className='flex justify-start space-x-5 my-3'>
                        <a href="https://github.com/tahapek5454" target='_blank' rel="noreferrer" > <i className="fa-brands fa-github text-gega-grey text-3xl"></i></a>
                        <a href='https://www.instagram.com/tahapek' target='_blank' rel="noreferrer" > <i className="fa-brands fa-instagram  text-gega-grey text-3xl"></i></a>
                        <a href='https://www.linkedin.com/in/taha-pek-413b1b221' target='_blank' rel="noreferrer" > <i className="fa-brands fa-linkedin  text-gega-grey text-3xl"></i></a>
                    </div>

                    <a href='https://drive.google.com/file/d/1XsLJrYgkEJFZwcbXQA3dGIHbc-o-rNHS/view?usp=share_link' target='_blank' rel="noreferrer" className='bg-gega-red hover:bg-rose-600 transation duration-500 rounded-full w-16 h-10 text-gega-grey flex justify-center items-center'>
