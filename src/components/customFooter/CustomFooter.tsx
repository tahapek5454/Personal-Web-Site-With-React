        ...
        <>
            <footer className='bg-black text-gega-grey' id='custom-footer'>
                ...
                <div className='container flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0 p-4'>
                    ...
                    <span onClick={()=>scrollToElement("project-body")} className='text-xl lg:text-2xl font-bold text-transparent bg-gradient-to-r bg-clip-text from-gega-red to-gega-grey whitespace-nowrap hover:cursor-pointer'>TAHA PEK</span>
