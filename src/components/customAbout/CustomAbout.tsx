                    ...
                    <div className='basis-2/3 px-2 md:px-0'>
                        ...
                        <div className='flex flex-col items-center justify-center mt-2 group'>
                            <ul className='list-none text-sm md:text-lg text-gega-grey font-open'>
                                <li className='mt-4 group-hover:mt-6 duration-500 '>Merhabalar, ben Taha Pek.</li>
                                <li className='mt-4 group-hover:mt-6 duration-500 '>09.08.2002 Sakarya' da doğdum.</li>
                                <li className='mt-4 group-hover:mt-6 duration-500 '>Necmettin Erbakan Fen Lisesi mezunuyum.</li>
                                <li className='mt-4 group-hover:mt-6 duration-500 '>Kocaeli Üniversitesi Bilgisayar Mühendisliği 4. sınıf öğrencisiyim.</li>
                                <li className='mt-4 group-hover:mt-6 duration-500 '>Doğuş Teknoloji'de Full-Stack-Developer Intern olarak görev almaktayım.</li>
                                <li className='mt-4 group-hover:mt-6 duration-500 '>Gelecekte iyi bir Full-Stack-Developer olmayı hedefliyorum.</li>
                            </ul>
                        </div>
